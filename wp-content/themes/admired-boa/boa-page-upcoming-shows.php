<?php
/** * Template Name: BOA Upcoming Shows Page*//** * The template for displaying Upcoming Show posts. * * @since admired 1.0
 */
...
get_header(); ?>
		...
		<section id="primary">
			...
			<?php if ( have_posts() ) : ?>
 				...
 				<header class="page-header">					<h1 class="page-title">          <span><a href="/">Home</a> > <a href="/news">News</a> > Upcoming Shows</span>          </h1> 				</header>

				<?php admired_content_nav( 'nav-above' ); ?>

				<?php /* Start the Loop */ ?>
        <?php        $post_limit = 5;        $args = array( 'cat' => '68', 'posts_per_page' => $post_limit, 'order' => 'desc' );        $loop = new WP_Query( $args );        $i = 0;        while ( $loop->have_posts() ) : $loop->the_post();         ?>
