...
UPGRADE AT YOUR OWN RISK: We added a legacy feature to the plugin which was tested on our local Wordpress and is working. Every eviroment is different. if you run into problem please visit http://blackbirdi.com/blog for support.
...
Updated and tested on latest version of Wordpress (3.4.1)

Most updates are because of users responding with requests. If you feel there is something that you would like to see in the plugin vist our site and post a comment.
